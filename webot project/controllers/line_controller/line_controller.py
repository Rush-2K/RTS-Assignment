...
def run_robot(robot):
    ...
    while robot.step(time_step) != -1:
        ...
        if left_anom:
            ...
            print('Coordinate values: ', gps_value)  
        ...
        if(6 < left_ir_value < 15) and (6 < right_ir_value < 15):
            left_speed = max_speed * 0.25
            right_speed = max_speed * 0.25 
